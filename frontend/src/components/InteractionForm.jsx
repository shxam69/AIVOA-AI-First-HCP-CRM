        ...
        <div className="section-header">
          ...
          <div className="section-header-text">
            ...
            <div className="section-header-desc">
              Primary contact and interaction type
            </div>
          </div>
        </div>
      ...
      <div className="form-section">
        <div className="section-header">
          ...
          <div className="section-header-text">
            ...
            <div className="section-header-desc">
              Topics covered and key results
            </div>
          </div>
        </div>
      ...
      <div className="form-section">
        <div className="section-header">
          ...
          <div className="section-header-text">
            ...
            <div className="section-header-desc">
              Items shared during the interaction
            </div>
          </div>
        </div>
      ...
      <div className="form-section">
        <div className="section-header">
          ...
          <div className="section-header-text">
            ...
            <div className="section-header-desc">
              Tasks and scheduled next steps
            </div>
          </div>
        </div>
          ...
          <div className="ai-suggestions">
            ...
            <div className="ai-suggestions-list">
              <div className="ai-suggestion-item">
                Schedule a follow-up meeting to review treatment outcomes
              </div>
              <div className="ai-suggestion-item">
                Send requested clinical materials within 48 hours
              </div>
              <div className="ai-suggestion-item">
                Add HCP to advisory board follow-up list
              </div>
            </div>
          </div>
        </div>
